...
import (
	...
	"github.com/cube2222/goaTest/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "TaskList-cli",
		Short: `CLI client for the TaskList service`,
	}
	...
	passwordSigner := newPasswordSigner(user, pass)

	// Initialize API client
	c.SetPasswordSigner(passwordSigner)
	c.UserAgent = "TaskList-cli/0"
...
// newPasswordSigner returns the request signer used for authenticating
// against the password security scheme.
func newPasswordSigner(user, pass string) goaclient.Signer {
